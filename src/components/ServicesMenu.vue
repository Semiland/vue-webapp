<template>
  ...
  >
    ...
    <transition name="mega-menu-fade">
      <div id="power-module-sm-icon" v-show="isVisible" class="mega-menu absolute normal-case font-normal bg-white shadow-md rounded-lg overflow-hidden border mt-4 w-full lg:w-160 z-30 lg:z-10 left-0 lg:-left-16">
          ...
          <ul class="w-full lg:w-1/2 px-4">
            <li class="mb-8">
              ...
              >
                ...
                <img class="pow-module" src="/pm.png" alt="">
                <span class="ml-2">
                  ...
                  <span class="block text-sm text-gray-600 group-hover:text-blue-800">Semilands core business</span>
                </span>
              </a>
            </li>
            <li class="mb-8">
              ...
              >
                ...
                <img class="test" src="/simulation.jpg" alt="">
                <span class="ml-2">
                  <span class="block font-bold text-blue-800 group-hover:text-blue-800">Testing and Calibration</span>
                  <span class="block text-sm text-gray-600 group-hover:text-blue-800">HALT&HASS, HTRB, HTGB, H3TRB, HTS, LTS, HAST, PC, TC,TS</span>
                </span>
              </a>
            </li>
          ...
          <ul class="w-full lg:w-1/2 px-4">
            <li class="mb-8">
              ...
              >
                ...
                <img class="customized" src="/customized.png" alt="">
                <span class="ml-2">
                  <span class="block font-bold text-blue-800 group-hover:text-blue-800">Customized Products</span>
                  <span class="block text-sm text-gray-600 group-hover:text-blue-800">Rapid prototyping</span>
                </span>
              </a>
            </li>
            <li class="mb-8">
              ...
              >
                ...
                <img class="simulation" src="/testing2.jpg" alt="">
                <span class="ml-2">
                  <span class="block font-bold text-blue-800 group-hover:text-blue-800">Simulation and Modeling</span>
                  <span class="block text-sm text-gray-600 group-hover:text-blue-800">Analytical modeling, simulation, calibration</span>
                </span>
              </a>
            </li>
            <!-- <li class="">
